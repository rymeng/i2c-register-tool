...
#ifndef I2C_REGISTER_TOOL_DRIVERS_CMSIS_DEVICE_INCLUDE_STM32F103XB_H_
#define I2C_REGISTER_TOOL_DRIVERS_CMSIS_DEVICE_INCLUDE_STM32F103XB_H_
...
typedef struct
{
  ...
  __IOM uint32_t SR;
  __IOM uint32_t DR;
  __IOM uint32_t CRCPR;
  __IOM uint32_t RXCRCR;
  __IOM uint32_t TXCRCR;
  __IOM uint32_t I2SCFGR;
} SPI_TypeDef;
...
{
  __IOM uint16_t EP0R;
  __IOM uint16_t RESERVED0;
  __IOM uint16_t EP1R;
  __IOM uint16_t RESERVED1;
  __IOM uint16_t EP2R;
  ...
  __IOM uint16_t EP5R;
  __IOM uint16_t RESERVED5;
  __IOM uint16_t EP6R;
  __IOM uint16_t RESERVED6;
  __IOM uint16_t EP7R;
  __IOM uint16_t RESERVED7[17];
  __IOM uint16_t CNTR;
  __IOM uint16_t RESERVED8;
  __IOM uint16_t ISTR;
  __IOM uint16_t RESERVED9;
  __IOM uint16_t FNR;
  __IOM uint16_t RESERVEDA;
  __IOM uint16_t DADDR;
  __IOM uint16_t RESERVEDB;
  __IOM uint16_t BTABLE;
  __IOM uint16_t RESERVEDC;
} USB_TypeDef;
